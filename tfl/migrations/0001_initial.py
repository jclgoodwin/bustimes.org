# Generated by Django 6.0.7 on 2026-07-23 17:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["base_version", "idx"],
                        name="tfl_block_base_ve_f26d8d_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["base_version", "block_idx"],
                        name="tfl_blockca_base_ve_0feb9f_idx",
                    )
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["base_version", "idx"],
                        name="tfl_journey_base_ve_2e5c12_idx",
                    ),
                    models.Index(
                        fields=["base_version", "block_idx"],
                        name="tfl_journey_base_ve_b8a712_idx",
                    ),
                    models.Index(
                        fields=["base_version", "pattern_idx"],
                        name="tfl_journey_base_ve_7d8dd1_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["base_version", "journey_idx"],
                        name="tfl_journey_base_ve_cb5150_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["base_version", "journey_idx"],
                        name="tfl_journey_base_ve_6df785_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "constraints": [
                    models.UniqueConstraint(
                        fields=("base_version", "contract_line_no"),
                        name="tfl_line_unique",
                    )
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["base_version", "idx"],
                        name="tfl_pattern_base_ve_97c20f_idx",
                    ),
                    models.Index(
                        fields=["base_version", "contract_line_no"],
                        name="tfl_pattern_base_ve_051fec_idx",
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["base_version", "idx"],
                        name="tfl_stopinp_base_ve_573a4f_idx",
                    ),
                    models.Index(
                        fields=["base_version", "pattern_idx"],
                        name="tfl_stopinp_base_ve_b92039_idx",
                    ),
                ],
            },
        ),
