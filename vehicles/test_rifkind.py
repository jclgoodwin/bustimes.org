...
class RifkindTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        destination = StopPoint.objects.create(common_name="Inspector Resnick's house",
                                               active=True, atco_code='1000DCMP4529')
        ...
        StopTime.objects.create(arrival='12:30', departure='12:30', sequence=0, trip=trip, stop=destination)

    @override_settings(CACHES={'default': {'BACKEND': 'django.core.cache.backends.locmem.LocMemCache'}})
    def test_vehicles_json(self):
        with vcr.use_cassette('data/vcr/rifkind.yaml', match_on=['body']):
