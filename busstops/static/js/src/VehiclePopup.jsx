...
export default function VehiclePopup({
  ...
  return (
    ...
    >
      ...
      {item.seats && (
        <div>
          <svg role="img" width="14" height="14" viewBox="0 0 118 177" xmlns="http://www.w3.org/2000/svg" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="1.5">
            <title>Seats</title>
            <path d="M108 9l-19 99-80-1 48 1v59" fill="none" stroke="currentColor" stroke-width="18"/>
          </svg>
          {" "}
          {item.seats}
        </div>
