...
from ...models import StopPoint, Region, Service, StopUsage
...
class ImportNornIronTest(TestCase):
    ...
    def test_enhance_stops(self):
        ...
        service = Service.objects.create(service_code='DUMMY', date='2016-12-27', region_id='NI')
        # Use a stop which is near a landmark
        StopUsage.objects.create(service=service, stop_id='700000000007', order=0)
